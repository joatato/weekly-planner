...
export function BlockTypeSidebar({ isOpen = false, onClose }: BlockTypeSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Un solo <aside> para las dos formas: drawer fijo en móvil, columna
          estática en escritorio. No se puede renderizar dos veces —cada
          BlockTypeChip registra un draggable con id `block-type-{id}`, y el
          segundo render pisaba al primero en el índice de dnd-kit con un nodo
          `display:none`. El DragOverlay salía de ahí midiendo 0×0 en (0,0). */}
      <aside
        ...
        className={cn(
          ...
          'lg:static lg:z-auto lg:w-60 lg:shrink-0 lg:translate-x-0 lg:border-r lg:border-gray-200 lg:shadow-none dark:lg:border-gray-700',
